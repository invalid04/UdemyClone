...
export default function SliderMain({images}:CarouselProps) {
  ...
  return (
    <div className='relative pb-16'>
        <div>
            <button className='absolute left-[2%] top-[50%] z-[40]' onClick={prevImage}><BsArrowLeft /></button>
            ...
            {current === 1 && (
                <div className='absolute top-[20%] left-[5%] bg-white p-6 max-w-[450px]'> 
                    ...
                    <h4 className='text=[1.2rem]'>Skills for your present (and your future). Get started with us today.</h4>
                </div>
            )}
            ...
            {current === 0 && (
                <div className='absolute top-[20%] left-[5%] bg-white p-6 max-w-[450px]'> 
                    ...
                    <h4 className='text=[1.2rem]'>HackLabs Business is trusted by 12.5k+ companies around the world. Find out what we can do for yours.</h4>
                </div>
            )}

            <button className='absolute right-[2%] top-[50%] z-[40]' onClick={nextImage}><BsArrowRight /></button>
